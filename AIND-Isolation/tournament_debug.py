...
def play_match(player1, player2):
    ...
    games = [Board(player1, player2, 7,7,USE_HUMAN), Board(player2, player1, 7,7,USE_HUMAN)]
...
def main():
    ...
    CUSTOM_ARGS = {"method": 'pvs', 'iterative': True}
    ...
    THE_agent = [Agent(CustomPlayer(score_fn=central_knight, **CUSTOM_ARGS), "ID_Improved")]
    ...
    test_agents = [
        ...
        #Agent(CustomPlayer(score_fn=other_guy, **CUSTOM_ARGS), "other_guy"),
        ...
        Agent(CustomPlayer(score_fn=custom_score, **CUSTOM_ARGS), "The chosen one")
    ]
