...
#Changed the tests to use the SudokuGame class.

class TestOnlySquare(unittest.TestCase):
    ''' Testing the Only square strategy '''
    
    before_only_sq_1 = {  
                            'A1': '', 'A2' :'' ,'A3':'13' ,'A4':'7' ,'A5':'6' ,'A6':'9' ,'A7':'4' ,'A8':'5' ,'A9':'8' ,
                            'B1':'4', 'B2':'5' ,'B3':'6' ,'B4':'2' ,'B5':'1' ,'B6':'8' ,'B7':'7' ,'B8':'9' ,'B9':'3' ,
                            'C1': '7', 'C2':'8' ,'C3':'9' ,'C4':'4' ,'C5':'3' ,'C6':'5' ,'C7':'1' ,'C8':'' ,'C9':'' ,
                            'D1': '3', 'D2':'4' ,'D3':'7' ,'D4':'9' ,'D5':'5' ,'D6':'2' ,'D7':'6' ,'D8':'8' ,'D9':'1' ,
                            'E1': '5', 'E2':'1' ,'E3':'8' ,'E4':'3' ,'E5':'7' ,'E6':'6' ,'E7':'' ,'E8':'' ,'E9':'' ,
                            'F1': '9', 'F2':'6' ,'F3':'2' ,'F4':'1' ,'F5':'8' ,'F6':'4' ,'F7':'3' ,'F8':'7' ,'F9':'5' ,
                            'G1': '', 'G2':'' ,'G3':'5' ,'G4':'8' ,'G5':'' ,'G6':'7' ,'G7':'' ,'G8':'' ,'G9':'' ,
                            'H1': '6', 'H2':'9' ,'H3':'4' ,'H4':'5' ,'H5':'2' ,'H6':'1' ,'H7':'8' ,'H8':'3' ,'H9':'7' ,
                            'I1': '8', 'I2':'7' ,'I3':'23' ,'I4':'6' ,'I5':'' ,'I6':'3' ,'I7':'5' ,'I8':'' ,'I9':''     
    ...
    possible_solutions_1 = [
        {'A1': '', 'A2' :'' ,'A3':'13' ,'A4':'7' ,'A5':'6' ,'A6':'9' ,'A7':'4' ,'A8':'5' ,'A9':'8' ,
                            ...
                            'G1': '', 'G2':'' ,'G3':'5' ,'G4':'8' ,'G5':'' ,'G6':'7' ,'G7':'' ,'G8':'' ,'G9':'' ,
                            'H1': '6', 'H2':'9' ,'H3':'4' ,'H4':'5' ,'H5':'2' ,'H6':'1' ,'H7':'8' ,'H8':'3' ,'H9':'7' ,
                            'I1': '8', 'I2':'7' ,'I3':'2' ,'I4':'6' ,'I5':'' ,'I6':'3' ,'I7':'5' ,'I8':'' ,'I9':'' }
        ]

    def test_only_sq(self):
        game = DiagonalSudokuGame(None)
        self.assertTrue(solution.only_square(self.before_only_sq_1, game) in self.possible_solutions_1,
                        "The only_square function produced an unexpected board.")
...
class TestNakedTwins(unittest.TestCase):
    ...
    def test_naked_twins(self):
        game = DiagonalSudokuGame(None)
        self.assertTrue(solution.naked_twins(self.before_naked_twins_1, game) in self.possible_solutions_1,
                        "Your naked_twins function produced an unexpected board.")

    def test_naked_twins2(self):
        game = DiagonalSudokuGame(None)
        self.assertTrue(solution.naked_twins(self.before_naked_twins_2, game) in self.possible_solutions_2,
                        "Your naked_twins function produced an unexpected board.")
...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    def test_solve(self):
        game = DiagonalSudokuGame(self.diagonal_grid)
    
        strategies = []
        strategies.append(solution.only_choice)    
        game.inject_strategies(strategies)

        t = game.solve()
        self.assertEqual(t, self.solved_diag_sudoku)
